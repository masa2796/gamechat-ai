    ...
    return (<div className="max-w-4xl mx-auto p-6">
      ...
      <div className="space-y-4">
        <div>
          ...
          <input id="question" type="text" value={question} onChange={(e) => setQuestion(e.target.value)} placeholder="テスト質問を入力してください" className="w-full p-3 border border-gray-300 rounded-md"/>
        </div>

        <button onClick={testAPI} disabled={loading || !question.trim()} className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 disabled:opacity-50">
        ...
        {response && (<div className="p-4 bg-gray-100 border border-gray-300 rounded-md">
