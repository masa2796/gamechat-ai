...
export default function RootLayout({ children, }) {
    ...
    return (<html lang="ja">
      <head>
        ...
        {process.env.NEXT_PUBLIC_RECAPTCHA_SITE_KEY && (<script src={`https://www.google.com/recaptcha/api.js?render=${process.env.NEXT_PUBLIC_RECAPTCHA_SITE_KEY}`} async defer/>)}
