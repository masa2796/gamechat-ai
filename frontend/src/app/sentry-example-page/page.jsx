    ...
    return (<div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://masaki-tanaka.sentry.io/issues/?project=4509535096406016">Issues Page</a>.
        ...
        {hasSentError ? (<p className="success">
            Sample error was sent to Sentry.
          </p>) : !isConnected ? (<div className="connectivity-error">
          ...
          </div>) : (<div className="success_placeholder"/>)}
